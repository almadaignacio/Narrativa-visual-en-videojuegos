...
#define SRP_FRAGMENT_ADDITIONAL_LIGHTS
	...
	#define USE_SPECULAR
	#endif
	#if defined(GF_SPECULAR) && (defined(GF_PPLIGHTS) || defined(DEFERRED))
	...
	|| defined(FRAGMENT_HANDLES_SHADOWS) || defined(SHADERPASS_GBUFFER))\
	&& !defined(GRASS_DEPTH)
...
uniform float terrainSlopeThresh;
uniform float terrainSlopeFade;
#endif
...
#if defined(GF_SPECULAR) || defined(DEFERRED)
...
#if defined(GF_USE_DITHER) || defined(GRASS_DEPTH) || defined(SEMI_TRANSPARENT)
